...
def argparer():
    ...
    parser.add_argument("--input_shape", default=(512,512,3),#(512, 512, 3),
    ...
    parser.add_argument("--gpu", default="0", type=str,
            help="number of gpu")
    parser.add_argument("--log_dir", default="./log/", type=str, help="log_dir")
...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        pspnet.save_weights('./save/model.h5')
        print('Model Saved')
